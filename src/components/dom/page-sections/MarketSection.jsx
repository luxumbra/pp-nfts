  ...
  return (
    ...
    >
      <TabList fontSize={{ base: '2.6vmin', lg: '2vmax' }} w="50%" flex="0 0 50%" justifyContent="flex-start" justifyItems="center" borderBottom="none">
        <Box p={5} pl={0}>
          <Tab
            borderBottom={tabIndex === 0 ? "4px solid green.400" : "2px solid transparent"}
          >
            <Text as="h3" className="gradient2 text" my={0}>Week One</Text></Tab>
        </Box>
        <Box p={5} pl={0}>
          <Tab  borderBottom={tabIndex === 1 ? "4px solid green.400" : "2px solid transparent"}><Text as="h3" className="gradient2 text" my={0}>Week Two</Text></Tab>
        </Box>
