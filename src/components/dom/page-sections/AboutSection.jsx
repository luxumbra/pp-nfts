        ...
        <Box className="__content__body" d={{ base: 'unset', md: "flex" }} flexFlow={{ base: 'column wrap', md: "row nowrap" }} alignItems="flex-start" justifyContent="space-between">
          ...
          >
            ...
            <Box>
              ...
              <Text>
                Taking on the form of proofs via NFTs. Offering you some flare to participate in the growing number of virtual worlds.</Text>
          ...
          <Container maxW={{ base: '100%', md: "50%" }} h="100%" p={0} mt={{ base: 5, md: 0 }} align="right">
            ...
            >
              ...
              <Text>Wearable NFT contracts on ReVesture also allow you, upon minting, to choose from a curated list of <Link href="https://giveth.io/projects" isExternal>regenerative projects</Link> aiming to restore the Global social and environmental ecosystem and donate % of revenue earned on first sales and/or royalties earned from secondary sales to the cause of your choosing.</Text>
